...
from . import log
from telex.plugin import NormalizePluginNameForModuleName
...
from telex.plugin.PluginFileLocator import PluginFileAnalyzerWithInfoFile
from telex.plugin.PluginFileLocator import PluginFileLocator
# imported for backward compatibility (this variable was defined here
# before 1.10)
from telex.plugin import PLUGIN_NAME_FORBIDEN_STRING
